 ...
 *
 * Note: While the UI and function names use plural phrasing for design consistency,
 * the current Office JS API for PowerPoint (getFileAsync) is limited to the single
 * active presentation that is hosting the add-in.
 */
