 ...
 * Note: While the UI and function name use plural terminology for design consistency,
 * the Office JS API for PowerPoint (getFileAsync) is limited to the single active presentation.
 */
