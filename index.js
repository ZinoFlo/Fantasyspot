...
/**
 * Reads the active presentation(s)/file(s) as a compressed byte stream.
 * Note: Pluralized terminology (active file(s), presentation(s)) is utilized for design consistency
 * and future-proofing, even though the Office JS API (getFileAsync) is technically restricted to
 * the single active document context hosting the taskpane.
 */
