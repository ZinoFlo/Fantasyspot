 ...
 * Note: While the UI and function name use pluralized terminology for design consistency,
 * the Office JS API (getFileAsync) is technically limited to the single active document
 * hosting the add-in.
 */
