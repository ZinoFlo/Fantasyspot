 ...
 * despite the technical limitation of getFileAsync to the single active presentation.
 */
async function readActiveFiles() {
  const status = document.getElementById("status");
  if (status) status.textContent = "Reading active file(s)...";

  // Small delay to ensure the UI renders the message before potentially blocking calls
