 ...
 *
 * Note on design consistency: Pluralized terminology (active file(s), presentation(s))
 * is used to provide a consistent UI, although the Office JS API is technically
 * limited to the single active document hosting the add-in.
 */
