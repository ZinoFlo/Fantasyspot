 ...
 * Note: Pluralized terminology is used for design consistency, although the Office JS API
...
async function readActiveFiles() {
  ...
  try {
    ...
    if (status) status.textContent = `File size: ${fileSize} bytes. Reading ${sliceCount} slices from presentation(s)...`;
