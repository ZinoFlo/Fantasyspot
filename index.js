 ...
 * although the Office JS API is technically limited to the single active document.
 */
async function readActiveFiles() {
  ...
  try {
    ...
    if (status) status.textContent = `Total byte size: ${fileSize}. Reading ${sliceCount} slice(s)...`;
